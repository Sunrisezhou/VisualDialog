...
def parse_args():
    ...
    parser.add_argument('--input_imgid', default='data/features_faster_rcnn_x101_train_v0.9_imgid.json', help='path to dataset, now hdf5 file')
...
if __name__ == '__main__':
    ...
    eval_dset = dl.validate(input_img_h5=args.input_img_h5, input_imgid=args.input_imgid, input_ques_h5=args.input_ques_h5,

...
def parse_args():
    ...
    parser.add_argument('--input_img_h5', default='data/features_faster_rcnn_x101_val.h5',
                        help='path to dataset, now hdf5 file')
    # parser.add_argument('--input_img_h5', default='data/features_faster_rcnn_x101_test.h5',
    #                     help='path to dataset, now hdf5 file')
    ...
    parser.add_argument('--input_json', default='data/visdial_params_v1.0.json',
                        help='path to dataset, now hdf5 file')
    parser.add_argument('--model_path', default='saved_models/2020-12-26-22-46/best_model.pth',
...
if __name__ == '__main__':
    ...
    eval_dset = dl.validate(input_img_h5=args.input_img_h5, input_ques_h5=args.input_ques_h5,#input_imgid="data/features_faster_rcnn_x101_train_v0.9_imgid.json",
